...
t.commodity = {}
t.commodity.commodityName = '商品名称'
t.commodity.commodityPrice = '商品价格'
t.commodity.commoditySpec = '商品规格'
t.commodity.type = '商品类型'
t.commodity.type1 = '问答币'
t.commodity.type2 = 'VIP'
t.commodity.type3 = '合伙人'
t.commodity.remark = '商品备注'
t.commodity.status = '是否开启'
t.commodity.status1 = '是'
t.commodity.status2 = '否'
t.commodity.time = '创建时间'

t.order= {}
t.order.userId = '用户ID'
t.order.userName = '用户昵称'
t.order.commodityName = '商品名称'
t.order.commodityType = '商品类型'
t.order.commodityType1 = '问答币'
t.order.commodityType2 = 'VIP'
t.order.commodityType3 = '合伙人'
t.order.payType = '通道类型'
t.order.payType1 = '支付宝'
t.order.payType2 = '公众号'
t.order.payType3 = '微信H5'
t.order.payType4 = '小程序'
t.order.payType5 = '卡密兑换'
t.order.orderCode = '订单号'
t.order.trilateralCode = '三方订单号'
t.order.rechargeAmount = '充值金额'
t.order.orderType = '订单状态'
t.order.orderType0 = '订单创建'
t.order.orderType1 = '支付中'
t.order.orderType2 = '支付成功'
t.order.orderType3 = '支付失败'
t.order.orderType4 = '订单超时'
t.order.commission = '返佣金额'

t.payconfig= {}
t.payconfig.id = '主键ID'
t.payconfig.appAppidCode = 'JSAPI APPID'
t.payconfig.appSecretCode = 'JSAPI SECRET'
t.payconfig.appId = '商户APPID'
t.payconfig.merchantId = '商户号'
t.payconfig.appSecret = '密钥'
t.payconfig.privateKey = '私钥'
t.payconfig.publicKey = '公钥'
t.payconfig.payUrl = '支付URL'
t.payconfig.payUrlMontage = 'URL拼接'
t.payconfig.notifyUrl = '回调地址'
t.payconfig.returnUrl = '跳转地址'
t.payconfig.merchantsName = '商户名称'
t.payconfig.payName = '支付名称'
t.payconfig.type = '支付类型'
t.payconfig.type1 = '支付宝'
t.payconfig.type2 = '微信公众号'
t.payconfig.type3 = '微信H5'
t.payconfig.type4 = '微信小程序'
t.payconfig.status = '是否开启'
t.payconfig.status1 = '是'
t.payconfig.status2 = '否'
t.payconfig.amountSuccess = '充值金额'
t.payconfig.remark = '通道备注'
t.payconfig.callName = '调用名称'
t.payconfig.icon = '通道图标'
t.payconfig.time = '配置时间'


t.withdrawal= {}
t.withdrawal.id = '主键ID'
t.withdrawal.userId = '用户id'
t.withdrawal.userName = '用户昵称'
t.withdrawal.withdrawalMoney = '提现金额'
t.withdrawal.realityMoney = '实到金额'
t.withdrawal.frontVacancies = '前余额'
t.withdrawal.behindVacancies = '当前余额'
t.withdrawal.serviceCharge = '手续费'
t.withdrawal.serviceChargeScale = '比例(%)'
t.withdrawal.makeCollectionsUrl = '二维码'
t.withdrawal.type = '收款类型'
t.withdrawal.type1 = '支付宝'
t.withdrawal.type2 = '微信'
t.withdrawal.status = '审核状态'
t.withdrawal.status0 = '待审核'
t.withdrawal.status1 = '审核通过'
t.withdrawal.status2 = '审核拒绝'
t.withdrawal.content = '审核内容'
t.withdrawal.time = '创建时间'
t.withdrawal.examineTime = '审核时间'
...
t.camille.type1 = '问答币'
t.camille.type2 = 'VIP'
t.camille.status = '卡密状态'
t.camille.status0 = '可使用'
t.camille.status1 = '已兑换'
